ACHIEVEMENTS = {
	...
	[73] = { name = "Green Thumb", grade = 2, points = 4, secret = true, description = "If someone gives Olhandods, you usually grow a beautiful plant from it within a few days. You like your house green and decorated with flowers. Probably you also talk to them." },
	...
	[83] = { name = "Polisher", grade = 2, points = 4, secret = true, description = "If Olhando a rusty item, you can't resist polishing it. There's always a little flask of rust remover in your inventory – who knows, there might be a golden armor beneath all that dirt!" },
	...
	[379] = { name = "Magnetised", grade = 1, points = 2, description = "This magnetic beast attracted you in a very literal way. Or was it attracted by your metal equipment? Anyway, Olhandom to be stuck together now." },
	...
	[397] = { name = "Stuntman", grade = 1, points = 3, description = "A drop of oil and you're good to go. This unique mount will roll merrily in and out of any strange place you want to visit. If Olhando no exit, you probably ended up in a circus ring. Ah well, the show must go on!" },
