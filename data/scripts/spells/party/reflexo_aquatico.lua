...
combat:setParameter(COMBAT_PARAM_EFFECT, CONST_ME_LOWBLOOD)
...
condition:setParameter(CONDITION_PARAM_DAMAGEMITIGATION, 10) -- Redução de dano em 10%
...
spell:name("Reflexo Aquatico")
spell:words("munio fluctus alatus")
spell:group("support")
spell:vocation("aprendiz de guerreiro da agua")
spell:castSound(SOUND_EFFECT_TYPE_SPELL_TRAIN_PARTY)
spell:id(151)
spell:cooldown(40 * 1000) -- Cooldown de 40 segundos
spell:groupCooldown(40 * 1000)
spell:level(35)
spell:mana(100)
