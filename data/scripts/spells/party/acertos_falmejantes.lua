...
condition:setParameter(CONDITION_PARAM_TICKS, 20 * 1000) -- Duração: 20 segundos
condition:setParameter(CONDITION_PARAM_FIELD_DAMAGE, 10) -- Dano do burn
condition:setParameter(CONDITION_PARAM_FIRE, 1000) -- Tempo de burn aplicado
...
function spell.onCastSpell(creature, var)
	...
	-- Aplica o efeito de burn a todos os membros da party
...
spell:name("Acertos Flamejantes")
spell:words("impulsus ignis communis")
spell:group("support")
spell:vocation("aprendiz de arqueiro do fogo")
spell:castSound(SOUND_EFFECT_TYPE_SPELL_TRAIN_PARTY)
spell:id(154)
spell:cooldown(35 * 1000) -- Cooldown de 35 segundos
spell:groupCooldown(35 * 1000)
spell:level(35)
spell:mana(90)
